package lambdasAndStreams.implementingMapFilterReduceUsingLambdasAndCollections;
...
public class MainReduction {
    ...
    public static void main(String[] args) {
        ...
        int reductionAll = reduce(Arrays.asList(reduction1, reduction2), 0, op);

        int reduction = reduce(ints, 0, op);

        System.out.println("Reduction : " + reduction);
        System.out.println("Reduction : " + reductionAll);
    }
}